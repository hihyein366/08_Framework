...
public class ParameterController {
	...
	/* Spring의 컨트롤러 메서드 작성 시 매개변수에 원하는 객체를 작성하면
	 * 존재하는 객체를 바인딩 또는 없으면 생성해서 바인딩(연결)
	 * 
	...
	public String paramTest2(
			...
			@RequestParam(value="publisher", required = false, defaultValue = "교보문곬") String publisher
	){
	...
	public String paramTest3(
		...
		// -> 제출된 모든 파라미터가 Map에 저장됨
		
		// -> 문제점 : key(name속성값) 중복되면 덮어쓰기 됨
		//  -> 같은 name속성 파라미터가 String[], List로 저장X
