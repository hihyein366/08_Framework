...
public class BoardServiceImpl implements BoardService {
	...
	private final BoardMapper mapper;  // final 붙은 애 자동으로 bean 등록됨
	...
	public Map<String, Object> selectBoardList(int boardCode, int cp) {
		...
		int offset = (cp - 1) * limit; // (cp-n) * 10 개 패스해서 페이지 넘기기
	...
	public Board selectOne(Map<String, Integer> map) {
		...
		// [여러 SQL을 실행하는 방법]
		// 1. 하나의 Service 메서드에서 여러 Mapper 메서드를 호츨하는 법
		...
		//  --> Mybatis의 <resultMap>, <collection> 태그를 이용에
		//		Mapper 메서드 1회 호출로 여러 SELECT 한 번에 소개
